...
{
  param_section <- paste(param_section, create_param_constant_line(parsed_fixed_term$"param_terms"[[1]]), sep = "")
...
{
  return(paste(param_section, create_param_constant_line("sigma", "<lower=0>"), sep = ""))
}
