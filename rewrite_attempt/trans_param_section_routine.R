...
add_varying_term_with_intercept_rand_eff_term_to_trans_param_section <- function(parsed_term, trans_param_section)
{
  ...
  trans_param_section <- paste(trans_param_section, create_trans_param_multiplication_assignment_line(parsed_term$"trans_param_terms"[[1]], cholesky_opt_term1, cholesky_opt_term2), sep = "")
